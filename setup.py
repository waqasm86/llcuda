...
setup(
    ...
    project_urls={
        'Bug Tracker': 'https://github.com/waqasm86/local-llama-cuda/issues',
        'Documentation': 'https://github.com/waqasm86/local-llama-cuda#readme',
        'Source Code': 'https://github.com/waqasm86/local-llama-cuda',
    },
